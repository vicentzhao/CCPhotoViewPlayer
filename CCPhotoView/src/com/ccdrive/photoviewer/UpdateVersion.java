...
public class UpdateVersion implements Runnable {
	...
	public static UpdateVersion instance(Context context, Handler handler,boolean boo,boolean flag) {
		mContext = context ;
...
//		mContext.startActivity(intent);
	 ...
	 public boolean slientInstall(String apkPath) throws IOException {
		  ...
		  Process proc = runtime.exec("pm install -r "+apkPathName); // 这句话就是shell与高级语言间的调用
